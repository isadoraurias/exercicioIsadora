class AcquirerData
  ...
  :product_identifier_description,
    ...
    def initialize(transaction_id:, affiliation_code:, summary_number:, card_number:, sale_data:, transaction_gross_amount:, transaction_tax_amount:, transaction_net_amount:, tax:, tid:, nsu:, order_id:, terminal_logic_number:, capture_date:, summary_identifier_number:, installment_count:, authorization_code:, capture_method_id:, capture_method_description:,   card_brand_id:, card_brand:, card_type_id:, card_type:, product_identifier_code:, product_identifier_description:)
